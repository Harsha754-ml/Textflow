...
import { getAnalyticsDeliveryRate, getAnalyticsSummary, getAnalyticsTopContacts, getAnalyticsVolume } from '../api/client';
...
export function AnalyticsPage() {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      const [summaryRes, volumeRes, deliveryRes, topRes] = await Promise.all([
